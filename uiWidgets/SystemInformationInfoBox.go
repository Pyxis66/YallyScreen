...
type SystemInformationInfoBox struct {
	*gtk.Box
	...
	yallyScreenResolutionLabel		*gtk.Label
...
func CreateSystemInformationInfoBox(
	...
	instance := &SystemInformationInfoBox {
		...
		yallyScreenResolutionLabel:	createStyledLabel(),
	...
	if instance.logLevel == "debug" {
		instance.Add(instance.yallyScreenResolutionLabel)
...
func (this *SystemInformationInfoBox) refreshYallyScreenResolutionLabel() {
	envResolution := os.Getenv(utils.EnvResolution)
	if envResolution == "" {
		envResolution = ">>MISSING<<"
	}
	yallyScreenResolutionString := fmt.Sprintf(
		"YALLYSCREEN_RESOLUTION configuration setting: %s",
		envResolution,
	)
	this.yallyScreenResolutionLabel.SetText(yallyScreenResolutionString)
}
...
func (this *SystemInformationInfoBox) Refresh() {
	...
	if this.logLevel == "debug" {
		this.refreshYallyScreenResolutionLabel()
