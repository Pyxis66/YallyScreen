...
func (this *ZOffsetRequest) Do(client *Client) (*dataModels.ZOffsetResponse, error) {
	...
	// bytes, err := client.doJsonRequest("POST", UriPyxis66Request, params, ConnectionErrors)
	bytes, err := client.doJsonRequest("GET", PluginPyxis66ApiUri, params, ConnectionErrors, true)
	if err != nil {
...
func (this *SetZOffsetRequest) Do(client *Client) error {
	...
	_, err := client.doJsonRequest("POST", PluginPyxis66ApiUri, buffer, ConnectionErrors, true)
	return err
}
