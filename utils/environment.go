...
// YallyScreenVersion is set during compilation.
var YallyScreenVersion = "1.0.0"
...
const (
	EnvStylePath   = "YALLYSCREEN_STYLE_PATH"
...
const (
	EnvLogLevel       = "YALLYSCREEN_LOG_LEVEL"
	EnvLogFilePath    = "YALLYSCREEN_LOG_FILE_PATH"
	EnvResolution     = "YALLYSCREEN_RESOLUTION"
...
func RequiredEnvironmentVariablesAreSet(apiKey string) bool {
	...
	// APIKey/OCTOPRINT_APIKEY can be set in either YallyScreen's config file,
...
func NameOfMissingRequiredEnvironmentVariable(apiKey string) string {
	...
	// being defined in YallyScreen's config file or in OctoPrint's config file,
...
func DumpSystemInformation() {
	...
	logger.Infof("YallyScreen version: %q", YallyScreenVersion)
