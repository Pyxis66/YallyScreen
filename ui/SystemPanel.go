...
type systemPanel struct {
	...
	yallyScreenInfoBox			*uiWidgets.YallyScreenInfoBox
	yallyScreenPluginInfoBox		*uiWidgets.YallyScreenPluginInfoBox
...
func (this *systemPanel) initialize() {
	...
	this.yallyScreenInfoBox = uiWidgets.CreateYallyScreenInfoBox(this.UI.Client, utils.YallyScreenVersion)
	this.Grid().Attach(this.yallyScreenInfoBox,       1, 0, 2, 1)

	this.yallyScreenPluginInfoBox = uiWidgets.CreateYallyScreenPluginInfoBox(this.UI.Client, this.UI.UIState, this.UI.OctoPrintPluginIsAvailable)
	this.Grid().Attach(this.yallyScreenPluginInfoBox, 3, 0, 1, 1)
